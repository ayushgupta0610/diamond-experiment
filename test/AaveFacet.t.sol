...
contract AaveFacetTest is Test {
    ...
    function testAaveDeposit() public {
        ...
        // Deposit WETH
        aaveFacet.aaveDeposit(WETH, depositAmount);
    ...
    function testAaveWithdraw() public {
        ...
        uint256 withdrawnAmount = aaveFacet.aaveWithdraw(WETH, withdrawAmount);
    ...
    function testAaveWithdrawMaxAmount() public {
        uint256 depositAmount = 1 ether;
        ...
        aaveFacet.aaveWithdraw(WETH, type(uint256).max);
    ...
    function testFailDepositZeroAmount() public {
        aaveFacet.aaveDeposit(WETH, 0);
    }

    function testFailWithdrawZeroAmount() public {
        aaveFacet.aaveWithdraw(WETH, 0);
    }
